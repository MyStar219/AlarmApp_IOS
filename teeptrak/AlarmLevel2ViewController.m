...
#import "AlarmLevel2ViewController.h"
#import "ActionSheetDatePicker.h"
#import "Constant.h"

@interface AlarmLevel2ViewController ()

@end

@implementation AlarmLevel2ViewController
...
- (void)viewDidLoad {
    ...
    m_daySchedules = [GlobalPool sharedObject].m_alarmSchedules2;
    m_alarmConfig = [GlobalPool sharedObject].m_alarmCfg2;
...
- (void) viewWillDisappear:(BOOL)animated{
    ...
    if (m_bClose){
        ...
        [[AlarmDB dbInstance] setAlarmConfig:ALARM_LEVEL2 config:m_alarmConfig];
